...
func TestWebSocketConnectionMsg(t *testing.T) {
...
func TestWebSocketUpdateNameMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
	...
	t.Run("update name successfully", func(t *testing.T) {
		sendMsg(t, conn, bus.WebSocketMessage{
			Type: "update-name",
...
func TestWebSocketVotingMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
	...
	t.Run("client can vote", func(t *testing.T) {
		sendMsg(t, conn1, bus.WebSocketMessage{
			Type: "vote",
	...
	t.Run("votes auto-reveal when all clients vote", func(t *testing.T) {
		sendMsg(t, conn2, bus.WebSocketMessage{
			Type: "vote",
			Payload: bus.VotePayload{
				Vote: "8",
			},
...
func TestWebSocketRevealVotesMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
...
func TestWebSocketResetMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
...
func TestWebSocketToggleSpectatorMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
...
func TestWebSocketToggleOwnerMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
...
func TestWebSocketUpdateStoryMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
...
func TestWebSocketNewVotingMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
...
func TestWebSocketVoteAgainMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
...
func TestWebSocketMultipleClientsMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
	...
	t.Run("votes auto-reveal when all 3 clients vote", func(t *testing.T) {
		...
		sendMsg(t, conn3, bus.WebSocketMessage{
			Type: "vote",
			Payload: bus.VotePayload{
				Vote: "8",
			},
...
func TestWebSocketDisconnectionMsg(t *testing.T) {
	ts := integration.NewTestServer(t)
	defer ts.Close()
...
func sendMsg(t *testing.T, conn *websocket.Conn, msg bus.WebSocketMessage) {
	t.Helper()
