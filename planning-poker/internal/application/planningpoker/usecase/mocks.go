...
// Source: planning-poker/internal/application/planningpoker/usecase (interfaces: UseCase,UseCaseR,UseCaseO)
//
// Generated by this command:
//
//	mockgen -destination mocks.go -typed -package usecase . UseCase,UseCaseR,UseCaseO
//
