...
func TestNewUpdateStoryUseCase(t *testing.T) {
	...
	uc := NewUpdateStoryUseCase(mockHub, mockLockManager)
...
func TestUpdateStoryUseCase_Execute_Success(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestUpdateStoryUseCase_Execute_SaveRoomError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestUpdateStoryUseCase_Execute_RoomNotFound(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestUpdateStoryUseCase_Execute_BroadcastError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
