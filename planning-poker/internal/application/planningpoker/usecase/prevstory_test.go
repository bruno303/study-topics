...
func TestNewPrevStoryUseCase(t *testing.T) {
	...
	uc := NewPrevStoryUseCase(mockHub, mockLockManager)
...
func TestPrevStoryUseCase_Execute_Success(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestPrevStoryUseCase_Execute_SaveRoomError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestPrevStoryUseCase_Execute_RoomNotFound(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestPrevStoryUseCase_Execute_BroadcastError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
