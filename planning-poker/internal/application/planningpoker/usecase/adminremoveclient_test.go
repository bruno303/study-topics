...
func TestNewAdminRemoveClientUseCase(t *testing.T) {
...
func TestAdminRemoveClientUseCase_Execute_Success(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestAdminRemoveClientUseCase_Execute_Success_NoBus(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestAdminRemoveClientUseCase_Execute_RoomNotFound(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestAdminRemoveClientUseCase_Execute_ClientNotFound(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestAdminRemoveClientUseCase_Execute_LeaveRoomError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestAdminRemoveClientUseCase_Execute_BusCloseError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
